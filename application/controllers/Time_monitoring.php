...
class Time_monitoring extends CI_Controller
{
    ...
    public function getTimeMonitoring()
    {
        ...
        foreach ($guest as $list) {
            ...
            $row[] = '<button class="btn btn-primary btn-sm checkout" id="'.$list->slip_app_no.'" data-service="'.$list->service.'" title="Check Out"><i class="bi bi-box-arrow-right"></i></button>
                      <button class="btn btn-success btn-sm extend" id="'.$list->slip_app_no.'" data-service="'.$list->service.'" title="Extend"><i class="bi bi-check2-square"></i></button>
                      <button class="btn btn-secondary btn-sm view" id="'.$list->slip_app_no.'" data-service="'.$list->service.'" title="View"><i class="bi bi-eye-fill"></i></button>';
