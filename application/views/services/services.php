                    ...
                    <div class="col-md-6">
                        <div class="inflatables">
                            ...
                            <ul>
                                ...
                                <li>A <span class="text-white fw-bold">maximum of two (2) kids per parent/guardian</span> only is allowed.</li>
                                <li>We strictly implement <span class="text-white fw-bold">NO Guardian No Entry</span> on our facilities
                                    for children 12 y/o and below.
                                </li>
                                <li>Wearing <span class="text-white fw-bold">grip socks</span> while playing or staying inside our facilities is required.</li>
                                ...
                                <li><span class="text-white fw-bold">Leaving</span> the children inside the inflatable alone to go to Jack's Adventure Park is not allowed.</li>
                                <li><span class="text-white fw-bold">Running or climbing inside the play area</span> must be avoided at all times,
                    ...
                    <div class="col-md-6">
                        <div class="park">
                            ...
                            <ul>
                                ...
                                <li>You will be asked to leave the facility if you do not observe the <span class="text-white fw-bold">safety rules.</span></li>
                                ...
                                <li>Please <span class="text-white fw-bold">stretch and warm up your body and wear grip socks</span> before using the facility.</li>
                                <li>All play parks are <span class="text-white fw-bold">not advisable for persons over 60 y/o, person with disablities, sick,
